...
from custom_util import generate_logger
...
def parse_option():
    ...
    parser.add_argument('--data_root', type=str, default='../datasets', metavar='N',
                        help='Root dataset')
...
def main():
    ...
    opt = parse_option()
    logger = generate_logger('evaluate')
    logger.info(opt)
    # test loader
    args = opt
    ...
    print('val_acc: {:.4f}, val_std: {:.4f}, time: {:.1f}'.format(val_acc, val_std,
                                                                  val_time))
    logger.info('val_acc: {:.4f}, val_std: {:.4f}, time: {:.1f}'.format(val_acc, val_std,
                                                                  val_time))
    ...
    print('val_acc_feat: {:.4f}, val_std: {:.4f}, time: {:.1f}'.format(val_acc_feat,
                                                                       val_std_feat,
                                                                       val_time))
    logger.info('val_acc_feat: {:.4f}, val_std: {:.4f}, time: {:.1f}'.format(val_acc_feat,
                                                                       val_std_feat,
                                                                       val_time))                                                                   
    ...
    print('test_acc: {:.4f}, test_std: {:.4f}, time: {:.1f}'.format(test_acc, test_std,
                                                                    test_time))
    logger.info('test_acc: {:.4f}, test_std: {:.4f}, time: {:.1f}'.format(test_acc, test_std,
                                                                    test_time))
